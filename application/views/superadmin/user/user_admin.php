...
<div class="table-responsive">
    ...
    <script>
        ...
        $('#add').submit(function (e) {
            e.preventDefault();
            $.ajax({
                url: "<?= site_url('superadmin/user_admin/api_add') ?>",
                type: "POST",
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('superadmin/user_admin/api_edit/') ?>" + form_data.get('id_admin'),
            dataType: "json",
            data: form_data,
            processData: false,
            contentType: false,
        ...
        swal({
            ...
            if (result.value) { // Only delete the data if the user clicked on the confirm button
                $.ajax({
                    type: "POST",
                    url: "<?php echo site_url('superadmin/user_admin/api_hapus/') ?>" + id_admin,
                    dataType: "json",
                }).done(function() {
                    swal({
                        title: "Berhasil",
