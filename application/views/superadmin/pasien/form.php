...
<div class="table-responsive">
    <table id="example1" class="table table-bordered  table-striped">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= hitung_usia($pasien['tgl_lahir']) ?> Tahun</td>
    ...
    <?php foreach($data->result_array() as $pasien): ?>
    ...
    <script>
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('superadmin/pasien/api_edit/') ?>" + form_data.get('id_pasien'),
            dataType: "json",
            data: form_data,
            processData: false,
            contentType: false,
        ...
        $(document).on('submit', '#gantipassword', function(e) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo site_url('superadmin/pasien/api_password/') ?>" + form_data.get('id_pasien'),
                dataType: "json",
                data: form_data,
                processData: false,
                contentType: false,
        ...
        swal({
            ...
            if (result.value) { // Only delete the data if the user clicked on the confirm button
                $.ajax({
                    type: "POST",
                    url: "<?php echo site_url('superadmin/pasien/api_hapus/') ?>" + id_pasien,
                    dataType: "json",
                }).done(function() {
                    swal({
                        title: "Berhasil",
