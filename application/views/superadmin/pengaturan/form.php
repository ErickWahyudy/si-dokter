...
<div class="table-responsive">
    ...
    <script>
     ...
     $(document).on('submit', '#edit', function(e) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('superadmin/pengaturan/api_edit/') ?>" + form_data.get('id_pengaturan'),
            dataType: "json",
            data: form_data,
            processData: false,
            contentType: false,
    ...
    $(document).on('submit', '#editlogo', function(e) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('superadmin/pengaturan/api_upload/') ?>" + form_data.get('id_pengaturan'),
            dataType: "json",
            data: form_data,
            processData: false,
            contentType: false,
