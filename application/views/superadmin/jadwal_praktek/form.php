...
<div class="table-responsive">
    ...
    <?php foreach($data->result_array() as $pengaturan): ?>
        ...
        <tbody>
            <tr>
                <th class="col-md-2">Jadwal Pendaftaran Pasien</th>
                <td><?= $pengaturan['jdwl_pendaftaran'] ?></td>
            </tr>
            <tr>
                ...
                <div class="modal-body table-responsive">
                    <table class="table table-bordered table-striped">
                        <form id="edit" method="post">
                            ...
                            <tr>
                                <th class="">Jadwal Pendaftaran Pasien</th>
                            </tr>
                            <tr>
                                <td>
                                    <input type="text" name="jdwl_pendaftaran"
                                        value="<?= $pengaturan['jdwl_pendaftaran'] ?>" class="form-control" required autocomplete="off">
                                </td>
                            </tr>
                            <tr>
    ...
    <script>
     ...
     $(document).on('submit', '#edit', function(e) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('superadmin/pengaturan/api_edit_jadwal/') ?>" + form_data.get('id_pengaturan'),
            dataType: "json",
            data: form_data,
            processData: false,
            contentType: false,
    ...
    $(document).on('submit', '#editstatus', function(e) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('superadmin/pengaturan/api_editstatus/') ?>" + form_data.get('id_pengaturan'),
            dataType: "json",
            data: form_data,
            processData: false,
            contentType: false,
