...
function viewPassword() {
    ...
    <script>
        ...
        $('#add').submit(function (e) {
            e.preventDefault();
            $.ajax({
                url: "<?= site_url('superadmin/dokter/api_add') ?>",
                type: "POST",
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('superadmin/dokter/api_edit/') ?>" + form_data.get('id_dokter'),
            dataType: "json",
            data: form_data,
            processData: false,
            contentType: false,
    ...
    $(document).on('submit', '#gantipassword', function(e) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('superadmin/dokter/api_password/') ?>" + form_data.get('id_dokter'),
            dataType: "json",
            data: form_data,
            processData: false,
            contentType: false,
        ...
        swal({
            ...
            if (result.value) { // Only delete the data if the user clicked on the confirm button
                $.ajax({
                    type: "POST",
                    url: "<?php echo site_url('superadmin/dokter/api_hapus/') ?>" + id_dokter,
                    dataType: "json",
                }).done(function() {
                    swal({
                        title: "Berhasil",
