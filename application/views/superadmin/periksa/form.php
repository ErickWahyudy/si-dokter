...
<div class="table-responsive">
                ...
                <div class="modal-body table-responsive">
                    <table class="table table-bordered table-striped">
                        ...
                        <tr>
                            ...
                            <td><?= hitung_usia($antrian['tgl_lahir']) ?> Tahun / <?= tgl_indo($antrian['tgl_lahir']) ?></td>
                        </tr>
                        <tr>
                            <td>Mens Terakhir</td>
    ...
    function dalam_antrian(id_antrian) {
        swal({
            ...
            if (result.value) { // Only delete the data if the user clicked on the confirm button
                $.ajax({
                    type: "POST",
                    url: "<?php echo site_url('superadmin/periksa/dalam_antrian/') ?>" + id_antrian,
                    dataType: "json",
                }).done(function() {
                    swal({
                        title: "Berhasil",
    ...
    function batal_periksa(id_antrian) {
        swal({
            ...
            if (result.value) { // Only delete the data if the user clicked on the confirm button
                $.ajax({
                    type: "POST",
                    url: "<?php echo site_url('superadmin/periksa/batal_periksa/') ?>" + id_antrian,
                    dataType: "json",
                }).done(function() {
                    swal({
                        title: "Berhasil",
    ...
    <script>
        ...
        function diperiksa(id_antrian) {
            swal({
                ...
                if (result.value) { // Only delete the data if the user clicked on the confirm button
                    $.ajax({
                        type: "POST",
                        url: "<?php echo site_url('superadmin/periksa/diperiksa/') ?>" + id_antrian,
                        dataType: "json",
                    }).done(function() {
                        swal({
                            title: "Berhasil",
        ...
        $(document).on('submit', '#edit', function(e) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo site_url('superadmin/periksa/sudah_periksa/') ?>" + form_data.get('id_antrian'),
                dataType: "json",
                data: form_data,
                processData: false,
                contentType: false,
