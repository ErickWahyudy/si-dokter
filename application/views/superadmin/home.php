...
<div class="col-md-2 col-xs-6">
          ...
          <div class="small-box bg-green">
            ...
            <a href="<?= base_url('superadmin/dokter');?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        ...
        <div class="col-md-2 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            ...
            <a href="<?= base_url('superadmin/user_admin');?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
