    ...
    <?php elseif($akses == 'Tutup'): ?>
        <div class="alert alert-info">
            <h4><i class="icon fa fa-warning"></i> Perhatian !</h4>
             Maaf, anda tidak bisa membuat jadwal periksa baru karena pendafataran sudah ditutup, silakan melakukan pendaftaran pada hari dan jam yang telah ditentukan.
        </div>
        <!-- jadwal pratek -->
        <div class="col-md-12">
        ...
        <!-- kembali ke home -->
        <div class="col-md-12">
            <a href="<?= site_url('pasien/home') ?>" class="btn btn-primary">Kembali</a>
        </div>
    <?php endif; ?>
    <?php endif; ?>
